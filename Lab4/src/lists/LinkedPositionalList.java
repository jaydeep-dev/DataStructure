...
public class LinkedPositionalList<E> implements PositionalList<E> {
  ...
  public int indexOf(Position<E> pos) throws IndexOutOfBoundsException, NullPointerException {
    ...
    while (first != target) {
      if (count >= size()) {
        throw new IndexOutOfBoundsException("The element does not exists in the list.");
      }
      first = first.getNext();
      count++;
    }
